...
#include "TS_AbilityTask_PlayMontageAndWait.generated.h"
...
UCLASS()
class TENNISSTORY_API UTS_AbilityTask_PlayMontageAndWait : public UAbilityTask
{
	...
	static UTS_AbilityTask_PlayMontageAndWait* CreatePlayMontageAndWaitProxy(UGameplayAbility* OwningAbility,
